...
* **Data Drift:** Mudanças repentinas em padrões de uso e faturamento podem tornar o modelo obsoleto (model drift).
...
* **Monitoring:** Ver *Monitoring Playbook* para detalhes de coleta de logs JSON, Prometheus e MLFlow Registry.
